...
class CombineHandlerTest @Throws(IOException::class)
constructor() {
    ...
    fun restApiMockShouldRespond() {
        RestAssured.get("http://localhost:$remotePort/test").then().body(Matchers.containsString(JsonObject().put("foo", "bar").encodePrettily()))
    }
